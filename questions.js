export const questions = [
  ...
  },
  {
    ...
    explanation: "Explanation:<br><br>The strip() method removes any whitespace characters from the beginning and end of the string, and the replace() method replaces all spaces with hyphens (-).",
